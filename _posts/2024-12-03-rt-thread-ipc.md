---
title: RT-Thread内核----线程间通信
date: 2024-12-03 20:05:00 +0800
categories: [RT-Thread]
tags: [RT-Thread, 内核, 线程间通信, 邮箱, 消息队列]
---
## 线程间通信
...
![邮箱工作示意图](/assets/img/posts/rt-thread-ipc/07mb_work.png)
...
![邮箱相关接口](/assets/img/posts/rt-thread-ipc/07mb_ops.png)
...
![消息队列工作示意图](/assets/img/posts/rt-thread-ipc/07msg_work.png)
...
![消息队列相关接口](/assets/img/posts/rt-thread-ipc/07msg_ops.png)
...
![同步消息示意图](/assets/img/posts/rt-thread-ipc/07msg_syn.png)
...
![信号工作机制](/assets/img/posts/rt-thread-ipc/07signal_work.png)
...
![信号相关接口](/assets/img/posts/rt-thread-ipc/07signal_ops.png)
...
![信号量使能](/assets/img/posts/rt-thread-ipc/07signal_enable.png)
