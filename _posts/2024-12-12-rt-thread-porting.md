---
title: RT-Thread内核----内核移植
date: 2024-12-12 20:40:00 +0800
categories: [RT-Thread]
tags: [RT-Thread, 内核, 内核移植, BSP]
---
## 内核移植
...
![栈里的上下文信息](/assets/img/posts/rt-thread-porting/10stack.png)
...
![线程之间的上下文切换](/assets/img/posts/rt-thread-porting/10ths_env1.png)
...
![中断到线程的切换](/assets/img/posts/rt-thread-porting/10ths_env2.png)
...
![rt_hw_context_switch_to() 流程图](/assets/img/posts/rt-thread-porting/10switch.png)
...
![rt_hw_context_switch()/ rt_hw_context_switch_interrupt() 流程图](/assets/img/posts/rt-thread-porting/10switch2.png)
...
![PendSV 中断处理](/assets/img/posts/rt-thread-porting/10pendsv.jpg)
