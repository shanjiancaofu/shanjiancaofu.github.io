---
title: RT-Thread内核----线程间同步（二）互斥量、事件集
date: 2024-11-30 18:45:00 +0800
categories: [RT-Thread]
tags: [RT-Thread, 内核, 线程间同步, 互斥量, 事件集]
---

# RT-Thread内核----线程间同步（二）互斥量、事件集
...
![线程间数据传递示意图](/assets/img/posts/rt-thread-mutex-event/06inter_ths_commu1.png)
...
![互斥量工作示意图](/assets/img/posts/rt-thread-mutex-event/06mutex_work.png)
...
![优先级反转 (M 为信号量)](/assets/img/posts/rt-thread-mutex-event/06priority_inversion.png)
...
![优先级继承 (M 为互斥量)](/assets/img/posts/rt-thread-mutex-event/06priority_inherit.png)
...
![互斥量相关接口](/assets/img/posts/rt-thread-mutex-event/06mutex_ops.png)
...
![事件集工作示意图](/assets/img/posts/rt-thread-mutex-event/06event_work.png)
...
![事件相关接口](/assets/img/posts/rt-thread-mutex-event/06event_ops.png)
...
![多事件接收示意图](/assets/img/posts/rt-thread-mutex-event/06event_use.png)
