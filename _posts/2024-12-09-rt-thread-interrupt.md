---
title: RT-Thread内核----中断管理
date: 2024-12-09 22:05:00 +0800
...
![中断示意图](/assets/img/posts/rt-thread-interrupt/09interrupt_work.png)
...
![Cortex-M 寄存器示意图](/assets/img/posts/rt-thread-interrupt/09interrupt_table.png)
...
![Cortex-M 工作模式状态图](/assets/img/posts/rt-thread-interrupt/09interrupt_work_sta.png)
...
![Cortex-M 内核和 NVIC 关系示意图](/assets/img/posts/rt-thread-interrupt/09relation.png)
...
![中断处理过程](/assets/img/posts/rt-thread-interrupt/09interrupt_handle.png)
...
![中断处理程序的 3 部分](/assets/img/posts/rt-thread-interrupt/09interrupt_work_process.png)
...
![rt_hw_context_switch_interrupt() 函数实现流程](/assets/img/posts/rt-thread-interrupt/09fun1.png)
...
![rt_hw_context_switch_interrupt() 函数实现流程](/assets/img/posts/rt-thread-interrupt/09fun2.png)
...
![中断中的线程切换](/assets/img/posts/rt-thread-interrupt/09ths_switch.png)
...
![中断模式驱动外设](/assets/img/posts/rt-thread-interrupt/09interrupt_reque.png)
